...
(use-package doom-modeline
  ...
  :config
  (set-face-attribute 'mode-line nil :font "Operator Mono-12")
  (set-face-attribute 'mode-line-inactive nil :font "Operator Mono-12")
...
(defun my-buffer-face-mode-fixed ()
  ...
  (interactive)
  (setq buffer-face-mode-face '(:family "Operator Mono" :height 120))
  (buffer-face-mode))
...
;;   (add-to-list 'eglot-server-programs (elixir-mode "/Users/shan/projects/elixir/elixir-ls/release/language_server.sh"))
...
(use-package lsp-elixir
  ...
  (setq lsp-elixir-ls-args '("/Users/shan/projects/elixir/elixir-ls/release/language_server.sh")))
