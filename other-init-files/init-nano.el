...
(set-face-attribute 'default nil
                    :height 140 :weight 'light :family "Myna")
...
(setq default-frame-alist
      '((height . 46) (width  . 120) (left-fringe . 0) (right-fringe . 0)
        (internal-border-width . 12) (vertical-scroll-bars . nil)
  ...
  '(:eval
    (let ((prefix (cond (buffer-read-only     '("RO" . nano-default-i))
      ...
      (list
       ...
       (propertize (concat " " time " ") 'face 'nano-faded) ; Add this line
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(add-node-modules-path apheleia auto-dark blamer cape
                           ...
                           merlin-iedit mise mistty mu4e-column-faces
