...
#+begin_src emacs-lisp
  (use-package neotree
    ...
    (neo-theme 'nerd-icons)                        ;; Set the default theme for Neotree to 'nerd' for a visually appealing look.
  ...
  ;; (custom-set-faces
  ;;  (set-face-attribute 'neo-dir-link-face nil :height 0.8)
  ;;  (set-face-attribute 'neo-file-link-face nil :height 80)
  ;;  (set-face-attribute 'neo-root-dir-face nil :height 0.85)
  ;; )
#+end_src
...
(use-package consult
  ...
  :bind (;; A recursive grep
         ("M-s M-g" . consult-grep)                   ;; Search for files names recursively
         ("M-s M-f" . consult-find)                   ;; Search through the outline (headings) of the file
         ("M-s M-o" . consult-outline)                ;; Search the current buffer
...
(add-to-list 'mu4e-bookmarks
             '(:name "Inbox - Kulcare"
                     ...
                     :key ?k))
(add-to-list 'mu4e-bookmarks
             '(:name "Inbox - Codetiger"
                     :query "maildir:/codetiger/INBOX"
                     :key ?c))
...
* Misc
#+begin_src emacs-lisp
;; Load gptel configuration
;; (require 'llm-config "~/.emacs.d/llm-config.el")
